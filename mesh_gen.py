...
mesh.addPoint(1, 0, 0, m_size, 2) 
mesh.addPoint(0, 1, 0, m_size, 3) 
mesh.addPoint(-1, 0, 0, m_size, 4) 
mesh.addPoint(0, -1, 0, m_size, 5)
...
mesh.extrude([(2, 2)], 0, 0, 1/32)


mesh.synchronize()

gmsh.model.mesh.generate(3)
gmsh.write("test_mesh2.mesh")
